# -*- coding: utf-8 -*-
"""
从「XXX_投放文章统计_0921.xlsx」生成 src/data/delivery_excel_0921.json。
...
BASE = Path(r'f:\9.16\02GEO\3.GEO数据监测系统\9.21投放文章汇总\投放分析 0921\投放分析 0921')
FILES = {
    'smart': '慕思智能床_投放文章统计_0921.xlsx',
    'ai': '慕思AI床垫_投放文章统计_0921.xlsx',
    'mattress': '慕思床垫_投放文章统计_0921.xlsx',
}
...
dest = Path('src/data/delivery_excel_0921.json')
