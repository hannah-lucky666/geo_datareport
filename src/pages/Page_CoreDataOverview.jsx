        ...
        <table className="w-full text-left border-collapse table-fixed flex-1">
          <thead>
            <tr className="text-white">
              ...
              <th colSpan={2} className="py-4 px-4 text-2xl font-black text-center border-l border-white/10 bg-[#4788FF]">综合竞品排名</th>
            </tr>
            ...
            {rows.map((row) => {
              ...
              return (
                <tr key={row.key} className="border-b border-zinc-200 bg-white hover:bg-slate-50/20 transition-colors">
                  ...
                  <td className="py-1.5 px-2 text-center border-r border-zinc-200 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.august.mention_rate)}</td>
                  <td className="py-1.5 px-2 text-center border-r-2 border-[#004CE5]/15 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.september.mention_rate)}</td>
                  <td className="py-1.5 px-2 text-center border-r border-zinc-200 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.august.top1_mention_rate)}</td>
                  <td className="py-1.5 px-2 text-center border-r-2 border-[#004CE5]/15 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.september.top1_mention_rate)}</td>
                  <td className="py-1.5 px-2 text-center border-r border-zinc-200 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.august.top3_mention_rate)}</td>
                  <td className="py-1.5 px-2 text-center border-r-2 border-[#004CE5]/15 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.september.top3_mention_rate)}</td>
                  <td className="py-1.5 px-2 text-center border-r border-zinc-200 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">NO. {p.august.influence_rank}</td>
                  <td className="py-1.5 px-2 text-center border-r-2 border-[#004CE5]/15 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">NO. {p.september.influence_rank}</td>
                </tr>
              );
            })}
          </tbody>
