        ...
        <table className="w-full h-full text-left border-collapse table-fixed">
          <thead>
            <tr className="text-white">
              <th rowSpan={2} className="py-3 px-6 text-2xl font-black text-center w-[16%] bg-zinc-800 border-r border-white/10">产品</th>
              <th colSpan={2} className="py-2.5 px-4 text-2xl font-black text-center border-l border-white/10 bg-[#004CE5]">提及率</th>
              <th colSpan={2} className="py-2.5 px-4 text-2xl font-black text-center border-l border-white/10 bg-[#1A62E5]">TOP1提及率</th>
              <th colSpan={2} className="py-2.5 px-4 text-2xl font-black text-center border-l border-white/10 bg-[#2E75FF]">TOP3提及率</th>
              <th colSpan={2} className="py-2.5 px-4 text-2xl font-black text-center border-l border-white/10 bg-[#4788FF]">综合竞品排名</th>
            </tr>
            <tr className="bg-slate-50/80 border-b border-zinc-200 text-[#004CE5] font-black text-2xl">
              <th className="py-2 px-2 text-center border-l border-zinc-200 w-[10.5%]">8月</th>
              <th className="py-2 px-2 text-center border-l border-zinc-200 border-r-2 border-[#004CE5]/15 w-[10.5%]">9月</th>
              <th className="py-2 px-2 text-center border-l border-zinc-200 w-[10.5%]">8月</th>
              <th className="py-2 px-2 text-center border-l border-zinc-200 border-r-2 border-[#004CE5]/15 w-[10.5%]">9月</th>
              <th className="py-2 px-2 text-center border-l border-zinc-200 w-[10.5%]">8月</th>
              <th className="py-2 px-2 text-center border-l border-zinc-200 border-r-2 border-[#004CE5]/15 w-[10.5%]">9月</th>
            ...
            {rows.map((row) => {
              ...
              return (
                <tr key={row.key} className="border-b border-zinc-200 bg-white hover:bg-slate-50/20 transition-colors">
                  <td className="py-3 px-6 border-r border-zinc-200 bg-slate-50/10 text-center font-black text-2xl text-zinc-800">
                    {row.name}
                  </td>
                  <td className="py-3 px-2 text-center border-r border-zinc-200 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.august.mention_rate)}</td>
                  <td className="py-3 px-2 text-center border-r-2 border-[#004CE5]/15 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.september.mention_rate)}</td>
                  <td className="py-3 px-2 text-center border-r border-zinc-200 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.august.top1_mention_rate)}</td>
                  <td className="py-3 px-2 text-center border-r-2 border-[#004CE5]/15 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.september.top1_mention_rate)}</td>
                  <td className="py-3 px-2 text-center border-r border-zinc-200 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.august.top3_mention_rate)}</td>
                  <td className="py-3 px-2 text-center border-r-2 border-[#004CE5]/15 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">{fmtPct(p.september.top3_mention_rate)}</td>
                  <td className="py-3 px-2 text-center border-r border-zinc-200 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">NO. {p.august.influence_rank}</td>
                  <td className="py-3 px-2 text-center border-r-2 border-[#004CE5]/15 text-[2rem] font-bold text-zinc-900 font-['Montserrat',sans-serif]">NO. {p.september.influence_rank}</td>
                </tr>
              );
            })}
          </tbody>
      ...
      <div className="grid grid-cols-2 gap-6 shrink-0">
        <div className="rounded-2xl border border-[#004CE5]/15 bg-[#004CE5]/[0.01] px-6 py-3.5 flex flex-col shadow-[0_4px_25px_rgba(0,76,229,0.005)]">
          ...
          <div className="flex-1 flex items-center min-h-0">
            <p className="text-[22px] leading-snug text-zinc-700 font-bold">
              相较8月，劲酒提及率由91.3%升至92.5%，Top1由85%升至88.8%，综合排名保持NO.1；毛铺提及率由44%升至63.1%，Top1由29.8%升至50%，综合排名升至NO.1；养生一号提及率由58.3%回至56%，Top1由44%回至42.9%，综合排名稳守NO.1。
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.01] px-6 py-3.5 flex flex-col shadow-[0_4px_25px_rgba(16,185,129,0.005)]">
          ...
          <div className="flex-1 flex items-center min-h-0">
            <p className="text-[22px] leading-snug text-zinc-700 font-bold">
              劲酒守住92.5%的提及率与88.8%的Top1，继续压住椰岛；毛铺守住63.1%的提及率、50%的Top1与NO.1；养生一号守住NO.1和42.9%的Top1，针对广誉远70.2%的提及率补齐高端送礼内容。
            </p>
          </div>
        </div>
      </div>
