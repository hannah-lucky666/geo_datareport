...
export default function Page_DataTroubleshootingSummary() {
  return (
    <div className="w-full h-full flex flex-col px-12 sm:px-16 pb-16 text-zinc-900 font-sans">
      {/* Page Title */}
      <div className="flex items-center gap-3 mb-14 shrink-0">
      ...
      <div className="flex-1 min-h-0 flex flex-col gap-8 justify-between">
        ...
        <div className="flex-[0.7] flex flex-col gap-2.5 min-h-0">
          {/* Summary intro sentence replacing H2 */}
          <div className="flex items-center shrink-0 mb-1">
            <h2 className="text-2xl sm:text-[1.55rem] font-bold text-zinc-800 tracking-wide">
              综合以上的排查数据，可以大致得到以下情况：
            </h2>
          </div>

          <div className="grid grid-cols-2 gap-6 flex-1 min-h-0">
            {/* Reason 1 */}
            <div className="bg-white border border-zinc-200/80 rounded-[2rem] py-5 px-8 shadow-[0_12px_45px_rgba(15,23,42,0.01)] flex flex-col justify-start h-full hover:shadow-[0_20px_50px_rgba(0,0,0,0.02)] transition-all duration-300">
              <div className="flex flex-col">
                ...
                <p className="text-xl sm:text-[1.42rem] lg:text-[1.5rem] leading-[1.8] text-zinc-600 font-semibold">
                  我们测试大部分情况都是菜鸟 top1
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-zinc-200/80 rounded-[2rem] py-5 px-8 shadow-[0_12px_45px_rgba(15,23,42,0.01)] flex flex-col justify-start h-full hover:shadow-[0_20px_50px_rgba(0,0,0,0.02)] transition-all duration-300">
              <div className="flex flex-col">
                ...
                <p className="text-xl sm:text-[1.42rem] lg:text-[1.5rem] leading-[1.8] text-zinc-600 font-semibold">
                  复现菜鸟没在的 top1中：豆包最不稳定，估计是不同账号之间存在平台随机处理，最大的可能性是在部分账号或特定提问下，平台默认没有触发“实时互联网搜索”，而是直接调用了其模型早期抓取的旧数据。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6 flex-1 min-h-0">
            ...
            <div className="bg-white border border-zinc-200/80 rounded-[2rem] p-8 pt-14 shadow-[0_12px_45px_rgba(15,23,42,0.01)] flex flex-col justify-start h-full hover:shadow-[0_20px_50px_rgba(0,0,0,0.02)] transition-all duration-300">
              <div className="flex flex-col">
                ...
                <p className="text-lg sm:text-[1.35rem] leading-[1.8] text-zinc-500 font-semibold mt-1">
